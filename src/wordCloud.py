...
getTopkeyWordsTFIDF(r'../documents/stop_words.txt',150,str_summary)
getTopkeyWordsTextRank(r'../documents/stop_words.txt',150,str_summary)
...
# 可以指定字体，或者按照词频生成
def show_WordCloud(stop_words,top_word,img_name):
...
show_WordCloud(stop_words,top_word_dict_TFIDF,'../image/word_cloud.jpg')
